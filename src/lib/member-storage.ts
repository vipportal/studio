...
const initialMembers: AdminMember[] = [
  { id: 1, name: "Ali Veli", phone: "5551112233", password: "password1", iban: "TR123456789", bank: "Garanti", tc: "11111111111", il: "İstanbul", ilce: "Beşiktaş", weeklyGain: "1500 TL", errorMessage: "Lütfen destek ekibiyle iletişime geçin, ödemeniz askıya alındı.", onayMesaji: "Para çekme talebiniz onaylanmıştır.", invoiceAmount: "1250 TL", status: "Aktif", transactionStatus: 'blocked' },
  { id: 2, name: "Ayşe Fatma", phone: "5554445566", password: "password2", iban: "TR987654321", bank: "Akbank", tc: "22222222222", il: "Ankara", ilce: "Çankaya", weeklyGain: "2000 TL", errorMessage: "Hata", onayMesaji: "İşlem başarılı.", invoiceAmount: "1800 TL", status: "Pasif", transactionStatus: 'allowed' },
];
...
export function getMembers(): AdminMember[] {
    ...
    try {
        ...
        if (storedMembers) {
            // Add transactionStatus and onayMesaji to existing members if they don't exist
